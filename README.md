Hello folks, you have to design & build the backend for the application and the ability for the hotel admin staff to add rooms, check-in, check-out etc.
...
https://github.com/azaylamba/hotelManagement
